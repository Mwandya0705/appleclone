...
const Features = () => {
  ...
  return (
    <section className ='h-full common-padding bg bg-zinc
    relative overflow-hidden'>
    <div className='screen-max-width'>
    <div className="mb-12 w-full">
        <h1 id ='features_title'
        className='section-heading'>Evplore the full story.</h1>
    </div>
    ...
    overflow-hidden">
        ...
        <div className="flex-center flex-col sm:px-10">
            ...
            flex items-center">
                ...
                className='w-full h-full object-coverobject-center'
